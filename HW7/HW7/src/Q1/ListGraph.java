...
/** A Q1.ListGraph is an extension of the Q1.AbstractGraph abstract class
...
public class ListGraph
  ...
  /** Get the edge between two vertices. If an
      edge does not exist, an Q1.Edge with a weight
  ...
  /** Load the edges of a graph from the data in an input file.
    ...
    * @param scan The Scanner that is connected
                          to the file that contains the data
   */
  public void loadEdgesFromFile(Scanner scan) throws
      IOException {
    /**** BEGIN EXERCISE ****/
    String line;
