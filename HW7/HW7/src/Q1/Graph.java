...
/** Interface to specify a Q1.Graph ADT. A graph is a set
...
*   of the Q1.Graph interface should provide a constructor
...
public interface Graph {
  ...
  /** Get the edge between two vertices.
      @param source The source vertex
      @param dest The destination vertex
      @return The Q1.Edge between these two vertices
              or an Q1.Edge with a weight of
