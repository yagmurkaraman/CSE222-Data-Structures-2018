...
public class RedBlackTree<E
    ...
    /**
     * This method generates 128
     */
    public void createWorstRBTree() {

        Random rand = new Random();
        Integer  start = rand.nextInt(50) + 1;
    ...
    private boolean checkNumber(ArrayList<Integer> list, Integer number) {
        ...
        return contain == false && isMax == true;
    }
