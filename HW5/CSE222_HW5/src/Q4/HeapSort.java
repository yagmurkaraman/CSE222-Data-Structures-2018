...
public class HeapSort {
     ...
     */
    public static < T
            extends Comparable < T >> int[] sort(int[] table) {
     ...
     */
    private static < T
            extends Comparable < T >> void buildHeap(int[] table) {
        int n = 1;
     ...
     */
    private static < T
            extends Comparable < T >> void shrinkHeap(int[] table) {
        int n = table.length;
     ...
     */
    private static < T
            extends Comparable < T >> void swap(int[] table,
                                                int i, int j) {
        int temp = table[i];
        table[i] = table[j];
        table[j] = temp;
