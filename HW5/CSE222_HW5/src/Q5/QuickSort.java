...
public class QuickSort {
   ...
   * @return sorted array
   */
  public static < T extends Comparable < T >> Integer[] sort(Integer[] table) {
   ...
   * @param <T> generic
   */
  private static < T extends Comparable < T >> void quickSort(Integer[] table,
                                                              int first,
                                                              int last) {
   ...
   * @param <T> generic
   */
  private static < T extends Comparable < T >> int partition(Integer[] table,
                                                             int first,
                                                             int last) {
   ...
   * @param <T> generic
   */
  private static < T extends Comparable < T >> void swap(Integer[] table,
                                                         int i, int j) {
    int temp = table[i];
    table[i] = table[j];
    table[j] = temp;
